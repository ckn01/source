...
export default function DynamicPageAdd() {
  ...
  const fetchLayout = async () => {
    try {
      ...
      document.title = `Add New ${layoutData.view_content.object.display_name ? layoutData.view_content.object.display_name : toLabel(objectCode)} (${layoutData.view_content.name}) - ${layoutData.view_content.tenant.name}`;
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        <div className="flex items-center gap-4 mb-3">
          ...
          <h1 className="text-2xl font-bold text-cyan-600">
            Add New {viewContent?.object?.display_name
